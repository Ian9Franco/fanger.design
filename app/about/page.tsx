...
// UPDATE: Integrated AboutHeroCarousel and DragCarousel components
// Referencia: Yucca about page structure with hero carousel and services drag section
// Motivo: Añadir hero carousel dinámico y sección de servicios con drag interactivo

export default function AboutPage() {
  const { t } = useLanguage()

  // UPDATE: Hero carousel slides data
  // Content comes from props/data, not hardcoded
  const heroSlides = [
    {
      id: 1,
      image: "/creative-team-collaboration.png",
      title: t.about.hero.title1 + " " + t.about.hero.title2,
      description: t.about.hero.reveal,
      label: t.about.hero.classification,
    },
    {
      id: 2,
      image: "/design-brainstorming.jpg",
      title: "Design Excellence Meets Strategic Thinking",
      description:
        "We believe great design is more than aesthetics—it's about solving real business challenges with creativity and innovation.",
      label: "Our Approach",
    },
    {
      id: 3,
      ...
      description:
        "From startups to established enterprises, we partner with brands ready to make a meaningful impact in their industry.",
      label: "Our Impact",
    },
  ]
  ...
  const sections = t.about.sections.map((section, index) => ({
    ...
    image:
      index === 0
        ...
        : index === 1
          ? "/design-brainstorming.jpg"
          : "/brand-strategy-meeting.png",
    coord: index === 0 ? "40.7128° N, 74.0060° W" : index === 1 ? "34.0522° N, 118.2437° W" : "51.5074° N, 0.1278° W",
  }))

  return (
    <main className="bg-white overflow-hidden">
      <AboutHeroCarousel slides={heroSlides} ctaText={t.contact.interested} ctaLink="/contact" />
      ...
      {/* Hero section - now simplified since carousel handles main hero */}
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <motion.h2
              ...
              className="mb-12 text-5xl md:text-7xl lg:text-8xl font-a font-black leading-[0.85] tracking-tighter"
            >
      ...
      {/* Stats Section */}
      <section className="relative z-10 container mx-auto px-6 lg:px-8 mt-64 border-t-2 border-black pt-24">
